...
<section class="services-layout2 bg-no-repeat bg-size-auto bg-top-right pt-130 pb-90">
    ...
    <div class="row">
        ...
        <div class="service-item">
            ...
            <h4 class="service-item__title"><?php the_title(); ?></h4>
            <p class="service-item__desc"><?php the_excerpt(); ?></p>
...
<div class="bg-no-repeat bg-top">
    <div class="bg-img"><img src="assets/images/backgrounds/11.jpg" alt="backgrounds"></div>
    <!-- =========================
    Contact layout 2
    =========================== -->
...
<!-- =====================
        Clients
======================== -->
<section class="clients border-top pt-50 pb-50 bg-gray">
    <div class="container">
    <div class="row align-items-center">
        <div class="col-sm-12 col-md-12 col-lg-12">
